        ...
        <div class="techland-form">
            <div class="card">
                <div class="card-header">
                    <div v-if="editData">
                        <i class="fa fa-edit"></i> {{ t('form.edit') }} {{ t('menu.brands') }}
                    </div>
                    <div v-else>
                        <i class="fa fa-plus"></i> {{ t('form.add') }} {{ t('menu.brands') }}
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        methods: {
            ...
            sendForm() {
                ...
                const apiService = this.editData ?
                    ApiService.put('/buyer/brand/' + this.form.uuid, this.form) :
                    ApiService.post('/buyer/brand', this.form)
                ;
